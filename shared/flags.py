...
flags.DEFINE_string('dataset_dir', '/home/vaibhav/tfprograms/dataset/pets',
...
flags.DEFINE_integer('training_set_size', 2000, 'Training set size.')
flags.DEFINE_integer('eval_set_size', 400, 'Evaluation set size.')
